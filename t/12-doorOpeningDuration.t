...
sub doorClosedDuration {
    my $ssAuthenticatorMockModule = Test::MockModule->new('SSAuthenticator::Lock');
    $ssAuthenticatorMockModule->mock('on', \&t::Mocks::doorOnTimed);
    $ssAuthenticatorMockModule->mock('off', \&t::Mocks::doorOffTimed);
